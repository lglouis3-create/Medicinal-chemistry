...
{id:'dd-12', prof:'Yendapally', tier:'old', topic:'disc', sub:'approach', concept:'dd-approaches-list',
 ...
 stem:'Which of the following is an approach used to discover new drugs?',
 options:[
  {t:'Observation of side effects', correct:true,
   why:'Observation of side effects is one of the six discovery approaches in the drug discovery deck, with sildenafil and the phenothiazines as its examples. The other five are discovery without a lead molecule, natural products, random screening, rational drug design and drug metabolism studies.'},
  {t:'Phase 4 clinical testing', correct:false,
   why:'Phase 4 is post-marketing surveillance, a stage a drug passes through once a candidate already exists. The clinical phases are how a molecule is tested, not how it is found.'},
  {t:'Preclinical toxicity testing', correct:false,
   why:'Preclinical testing is where a candidate is evaluated in vitro and in animals before human trials. It is a development stage, not a way of finding a new molecule.'},
  {t:'Chemical synthesis', correct:false,
   why:'Chemical synthesis is how a molecule is made once it has been designed or identified. The deck lists it among the sources of drug molecules, not among the six approaches to discovering one.'}],
 teach:[
...
{id:'dd-14', prof:'Yendapally', tier:'old', topic:'disc', sub:'approach', concept:'dd-side-effects',
 tags:['recall','reasoning'], source:'slide',
 stem:'Sildenafil was developed for angina and approved for erectile dysfunction. This illustrates which drug-discovery approach, and which other example belongs to it?',
 options:[
  {t:'Side effects; phenothiazine antipsychotics', correct:true,
  ...
  {t:'Rational design; zanamivir', correct:false,
  ...
  {t:'Random screening; prontosil', correct:false,
  ...
  {t:'No lead molecule; penicillin', correct:false,
...
{id:'dd-15', lowYield:true, prof:'Yendapally', tier:'old', topic:'disc', sub:'sources', concept:'dd-biologics',
 tags:['recall','compare'], source:'slide',
 stem:'Which of the following is true of a biologic compared with a small-molecule drug?',
 options:[
  {t:'Made in or from living systems', correct:true,
  ...
  {t:'Obtained from any natural source', correct:false,
  ...
  {t:'Well-defined, reproducible structure', correct:false,
  ...
  {t:'Always a monoclonal antibody', correct:false,
...
{id:'sar-1', prof:'Yendapally', tier:'old', topic:'disc', sub:'sar', concept:'sar-brown-fraser',
 tags:['recall','reasoning'], source:'slide',
 stem:'Brown and Fraser (1869) converted tertiary amines to quaternary ammonium compounds and observed muscle relaxation. What conclusion followed from their work?',
 options:[
  {t:'Structure influences biological activity', correct:true,
  ...
  {t:'All quaternary ammoniums relax muscle', correct:false,
  ...
  {t:'Bioisosterism was established', correct:false,
  ...
  {t:'Random screening found tubocurarine', correct:false,
...
{id:'sar-3', prof:'Yendapally', tier:'old', topic:'disc', sub:'sar', concept:'antagonist-size-observation',
 ...
 stem:'Tubocurarine blocks the receptors that acetylcholine activates. Which generalisation about antagonists does this pair illustrate?',
 options:[
  {t:'Antagonists are larger than the native agonist', correct:true,
  ...
  {t:'Antagonists carry a quaternary nitrogen', correct:false,
  ...
  {t:'Blocker and transmitter act at different receptors', correct:false,
  ...
  {t:'The blocker lacks receptor affinity', correct:false,
...
{id:'ab2-1', dupOf:'sa-ab2-1', prof:'Yendapally', tier:'old', topic:'admet', sub:'ddi', concept:'ab2-four-mechanisms',
 tags:['list','recall'], source:'slide',
 stem:'Which of the following is a mechanism by which a co-administered substance changes the oral absorption of a drug?',
 options:[
  {t:'Chelation with metal ions', correct:true,
   why:'Chelation with metal ions is one of the four absorption mechanisms in the deck: a surface the drug adsorbs onto, a metal ion that chelates it (iron and antacids with tetracycline), a change in gastrointestinal motility, and a change in the transport proteins of the gut wall. Each acts before the drug has crossed the gut wall.'},
  {t:'Enzyme induction', correct:false,
   why:'Induction changes how fast a drug is metabolised once it is in the body. That is a metabolic interaction, not an absorption one; it does not alter how much drug crosses the gut wall.'},
  {t:'Change in urinary pH', correct:false,
   why:'Urinary pH changes how much drug is reabsorbed in the renal tubule, which is pH trapping and belongs to elimination. It acts after the drug has already been absorbed and distributed.'},
  {t:'Enterohepatic recycling', correct:false,
   why:'Enterohepatic recycling returns drug from bile and gut back to the circulation after it has been absorbed, metabolised and excreted into bile. It prolongs duration rather than changing absorption.'}],
 teach:[
...
{id:'ab2-3', prof:'Yendapally', tier:'old', topic:'admet', sub:'ddi', concept:'ab2-motility',
 ...
 stem:'Loperamide and bisacodyl both change drug absorption by altering gastrointestinal motility. How does each act?',
 options:[
  {t:'Loperamide slows transit; bisacodyl stimulates peristalsis', correct:true,
  ...
  {t:'Both slow transit and raise absorption', correct:false,
  ...
  {t:'Loperamide adsorbs drug; bisacodyl chelates', correct:false,
  ...
  {t:'Both act on gut P-glycoprotein', correct:false,
...
{id:'ab2-4', prof:'Yendapally', tier:'old', topic:'admet', sub:'ddi', concept:'ab2-cholestyramine',
 ...
 stem:'Cholestyramine given with furosemide decreases the diuretic effect. Cholestyramine hinders drug absorption by:',
 options:[
  {t:'Adsorbing the drug onto its surface', correct:true,
  ...
  {t:'Absorbing the drug', correct:false,
  ...
  {t:'Chelating the drug', correct:false,
  ...
  {t:'Inducing an efflux transporter', correct:false,
...
{id:'ab2-5', dupOf:'sa-ab2-2', prof:'Yendapally', tier:'old', topic:'admet', sub:'prodrug', concept:'ab2-prodrug-def',
 tags:['definition','list'], source:'slide',
 stem:'What is a prodrug?',
 options:[
  {t:'Inactive in vitro, activated in vivo', correct:true,
  ...
  {t:'Active as given, inactivated by metabolism', correct:false,
  ...
  {t:'A metabolite developed as a drug', correct:false,
  ...
  {t:'Active in vitro and in vivo', correct:false,
...
{id:'ab2-6', prof:'Yendapally', tier:'old', topic:'admet', sub:'prodrug', concept:'ab2-prodrug-match',
 ...
 stem:'Haloperidol decanoate is given intramuscularly once a month; haloperidol is taken orally two or three times a day. What accounts for the difference?',
 options:[
  {t:'Higher log P; slow release from fat', correct:true,
  ...
  {t:'More water-soluble; faster absorption', correct:false,
  ...
  {t:'Peptide-transporter uptake', correct:false,
  ...
  {t:'Resists metabolism; slower clearance', correct:false,
